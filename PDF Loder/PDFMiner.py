...
def load_pdf_with_pdfminer():
    ...
    try:
        ...
        print("提示: PDFMiner 是纯 Python 实现，擅长精细的布局分析，但速度可能不如 C++ 库 (如 PyMuPDF)。")
        ...
        output_file_path = os.path.join(script_dir, "PDFMinerLoader.txt")
        ...
        with open(output_file_path, "w", encoding="utf-8") as f:
            ...
            for i, doc in enumerate(docs):
                ...
                # --- 提取元数据 ---
                # PDFMiner 提取的 metadata 包含 source, title, subject 等
